            ...
            {headerGroup.headers.map(header => {
              return (
                <TableHead
                  ...
                  className={cn(getCommonPinningStyles(header.column), header.column.columnDef.meta?.className)}
                >
            ...
            <TableRow key={row.id} data-state={row.getIsSelected() && 'selected'}>
              {row.getVisibleCells().map(cell => (
                <TableCell
                  ...
                  className={cn(getCommonPinningStyles(cell.column), cell.column.columnDef.meta?.className)}
