      ...
      <div className="shrink-0 group relative size-22 grid place-items-center bg-background-secondary rounded-lg">
        ...
        {isImage ? (
          <img
            ...
            className={cn('size-full object-cover shadow-sm rounded-lg overflow-hidden', isUploading && 'opacity-30')}
          />
        ) : (
    ...
    >
      <div className="flex gap-1 items-center">
        ...
        <div className="relative flex-1 flex flex-col gap-0.5">
          ...
          {uploaderFile.error && <span className="text-xs text-destructive-foreground">{uploaderFile.error}</span>}
          {!uploaderFile.error && (
          ...
          <div className="absolute -bottom-[5px] left-0 right-0">
            <Progress value={uploaderFile.percent} barClassName={cn('h-1 opacity-0', isUploading && 'opacity-100')} />
          </div>
        </div>
        ...
        <TooltipTrigger>
          <Focusable>
            <Button
              ...
              asChild
            >
              <a href={uploaderFile.url} download={uploaderFile.name} target="_blank" rel="noopener noreferrer">
                <DownloadIcon />
              </a>
            </Button>
          </Focusable>
