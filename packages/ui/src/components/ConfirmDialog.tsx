        ...
        <div className="flex flex-col gap-4">
          <DialogHeader>
            <div className="mb-2">
              ...
              {variant === 'destructive' && <CircleXIcon className="size-6 text-destructive-foreground" />}
            </div>
            <DialogTitle>{data?.title || 'Confirm'}</DialogTitle>
            <DialogDescription>{data?.description || 'Are you sure you want to confirm?'}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
